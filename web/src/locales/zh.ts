...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图形的模块化检索增强生成 (RAG) 系统`,
    ...
    setting: {
      ...
      sureRemoveMember: '确定要移除该成员吗？',
      createTeamSuccess: '创建团队成功',
      applySuccess: '申请成功',
      handleSuccess: '处理成功',
      createTeamTitle: '创建团队',
      createTeamTip: '每个用户只能创建一个团队，请谨慎创建命名！',
      teamNameRequired: '请输入团队名称',
      teamNameExists: '团队名称已存在',
      teamNameLength: '团队名称长度应在2-32个字符之间',
      teamNameInvalid: '团队名称只能包含中英文、数字、下划线、点号和破折号',
      teamNameDuplicate: '团队名称已存在',
    },
    message: {
      registered: '注册成功',
      logout: '登出成功',
